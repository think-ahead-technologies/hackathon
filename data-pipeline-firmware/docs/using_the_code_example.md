...
The following example clones the "[Empty application](https://github.com/Infineon/mtb-example-psoc-edge-empty-app)" application with the desired name "EmptyApp" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-empty-app --user-app-name EmptyApp --target-dir "C:/mtb_projects"
   ```
