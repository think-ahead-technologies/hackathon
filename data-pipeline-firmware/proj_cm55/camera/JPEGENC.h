 ...
 * Original library distinguishes Arduino vs. other platforms. For this PSoC
 * project we simply use standard C headers; define ARDUINO if compiling under
 * an Arduino core to retain legacy behavior.
 */
#if defined(ARDUINO)
#include <Arduino.h>
#else
